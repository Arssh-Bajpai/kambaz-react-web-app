import "./index.css";
import { Container } from "react-bootstrap"; // Import Container from Material-UI
...
export default function Lab2() {
  return (
    <Container> {/* Replaced <div> with <Container> */}
      <div id="wd-lab2">
        <h2>Lab 2 - Cascading Style Sheets</h2>
        <h3>Styling with the STYLE attribute</h3>
        <div className="text-container"> {/* Wrapped text inside a container div */}
          <p>
        ...
        <div id="wd-css-id-selectors">
          ...
          <p id="wd-id-selector-1">
            Instead of changing the look and feel of all elements of the same name, 
          ...
          <div className="wd-selector-1">
            ...
            <div className="wd-selector-2">
              <p className="wd-selector-3">
                ...
                <br />
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               bb b                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      <code>.wd-selector-2 .wd-selector-3</code>
                <br />
                ...
                <br />
                You can combine these relationships to create specific styles depending on 
